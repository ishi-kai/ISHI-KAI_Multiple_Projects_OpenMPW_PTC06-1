...
N 190 -250 200 -250 {
lab=VDD}
C {primitives/nfet.sym} 170 -90 0 0 {name=M2 model=NCHOR1EX W=600.0u L=8.0u m=1}
C {primitives/pfet.sym} 170 -250 0 0 {name=M1 model=PCHOR1EX W=1200.0u L=10.0u m=1}
